...
public class LeafBoardActivity extends Activity implements OnClickListener, GetWebPageInterface{
	
	// temporary variables to store data from HTML, updated when following pages call
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new LeafBoardTask(this, this.getString(R.string.serverName)).execute(cookie, boardUrl + "1");
	}
	...
	private void setLeafBoardUI() {
        ...
        listItemAdapter = new SimpleAdapter(this,
                ...
                new String[] {	leafItemTitleStr, 
        						leafItemTextStr}, // dynamic array and ListItem correspondings        
        ...
        // set custom list view and listener
     	...
     	topicLv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Toast.makeText(getApplicationContext(), "Url:" + postUrl, Toast.LENGTH_LONG).show();
	...
	public void onClick(View v) {
    	...
    	case R.id.leafBoardMoreButton:
			if (displayedPage >= pageCount)
				...
				displayedPage++;
				String followingPageUrl = boardUrl + Integer.toString(displayedPage);
				System.out.println("Loading follow page URL: " + followingPageUrl);
				pageMoreBtn.setText(this.getString(R.string.loadingMorePageText));
				new LeafBoardTask(this, serverName).execute(cookie, followingPageUrl);
			}
			break;
    	}
	}
