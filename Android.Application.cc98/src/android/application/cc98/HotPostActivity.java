...
public class HotPostActivity extends Activity implements
	...
	private void fillContent() {
		SimpleAdapter adapter = new SimpleAdapter(this, getData(),
				R.layout.hotpost_list_item, new String[] {"content",
						"board", "author", "time", "attentioncount",
						"postcount", "clickcount" }, new int[] { 
						R.id.contentText, R.id.boardText, R.id.authorText,
						R.id.timeText, R.id.attentionCountText,
						R.id.replyCountText, R.id.clickCountText });
